...
namespace ComicBookShared.Data
{
    public class ComicBooksRepository : BaseRepository<ComicBook>
    {
        ...
        public bool ComicBookHasArtistRoleCombination(int artistId, int roleId, int comicBookId)
        {
            return Context.ComicBookArtists.Any(cba => cba.ComicBookId == comicBookId &&
